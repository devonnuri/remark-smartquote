import { Node, Nodes, Parents, Text } from 'mdast';
import { VisitorResult, visitParents } from 'unist-util-visit-parents';

import { Quotes } from '@/index.js';

export function replaceQuotes(tree: Nodes, quotes: Quotes): void {
  ...
  function visitor(node: Text, ancestors: Parents[]): VisitorResult {
    ...
    const [singleOpen, singleClose, doubleOpen, doubleClose] = quotes;
